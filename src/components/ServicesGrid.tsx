...
const ServicesGrid = () => {
  ...
  return (
    <section id="services" className="py-24 bg-gradient-to-br from-[hsl(210,100%,98%)] via-[hsl(230,100%,97%)] to-[hsl(250,100%,98%)] relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Floating particles */}
        <div className="absolute top-40 left-40 w-2 h-2 bg-green-700 rounded-full animate-ping"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-20 animate-fade-in">
          ...
          <h2 className="text-5xl lg:text-7xl font-bold mb-6 leading-tight">
            <span className="text-foreground drop-shadow-2xl">World-Class</span>
            <br />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              <Card 
                key={index} 
                className="group glass hover:bg-white/80 hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-3 animate-fade-in cursor-pointer relative overflow-hidden"
              ...
              >
                ...
                <CardHeader className="text-center relative z-10 pb-6">
                  ...
                  <CardTitle className="text-2xl font-bold text-foreground group-hover:text-green-700 transition-colors duration-300">
                    {service.title}
                  </CardTitle>
                </CardHeader>
                <CardContent className="text-center relative z-10">
                  ...
                  <div className="flex items-center justify-center text-green-700 font-semibold group-hover:text-foreground transition-colors duration-300">
                    <span className="mr-2">Learn More</span>
                    <ArrowRight className="w-4 h-4 transform group-hover:translate-x-2 transition-transform duration-300" />
                  </div>
                  {/* Enhanced progress bar */}
                  <div className="mt-6 h-1 bg-blue-100/30 rounded-full overflow-hidden">
        ...
        <div className="text-center mt-20 animate-fade-in delay-700">
          <Link to="/services">
            <button className="group relative overflow-hidden bg-gradient-to-r from-green-700 to-blue-400 hover:from-green-800 hover:to-blue-500 text-white px-12 py-6 rounded-2xl font-bold text-lg shadow-2xl hover:shadow-green-700/30 transform hover:-translate-y-2 hover:scale-105 transition-all duration-300">
