    ...
    <header className="relative z-50">
      ...
      <div className="glass text-foreground py-4 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="group flex items-center space-x-2 glass rounded-full px-4 py-2 hover:bg-white/80 transition-all duration-300 transform hover:scale-105">
              <Clock className="w-4 h-4 text-pink-400 group-hover:animate-pulse" />
              <span className="font-medium">Mon-Fri: 8AM-8PM | Sat-Sun: 9AM-6PM</span>
            </div>
          </div>
          <div className="flex items-center space-x-3">
            <div className="w-6 h-6 bg-gradient-to-r from-blue-400 to-pink-400 rounded-lg flex items-center justify-center animate-pulse">
              <Shield className="w-4 h-4 text-white" />
            </div>
            <div className="text-sm bg-gradient-to-r from-blue-400 to-pink-400 bg-clip-text text-transparent font-bold animate-text-glow">
      ...
      <div className="relative py-10 md:py-16 flex items-center justify-center overflow-visible">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-blue-100 via-pink-100 to-purple-100 opacity-80"></div>
          {/* Floating orbs with new animations, using theme colors */}
          <div className="absolute top-1/4 left-1/4 w-40 h-40 bg-blue-200/20 rounded-full blur-3xl animate-float-slow"></div>
          <div className="absolute bottom-1/4 right-1/4 w-40 h-40 bg-pink-200/20 rounded-full blur-3xl animate-float-delay"></div>
          {/* Decorative blurred orb behind logo/text, using theme color */}
          <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-blue-100/30 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 animate-pulse"></div>
        </div>
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 animate-fade-in-up relative z-10">
          ...
          <div className="flex flex-col items-start md:items-start gap-2">
            <h1 className="text-3xl md:text-5xl font-extrabold leading-tight relative">
              <span className="bg-gradient-to-r from-blue-400 via-pink-400 to-purple-400 bg-clip-text text-transparent animate-gradient-text relative inline-block drop-shadow-[0_2px_16px_rgba(80,200,255,0.18)]">
                Maiya Multi Speciality Hospital
                {/* Floating dots decoration */}
                <span className="absolute -top-2 -right-2 w-2 h-2 bg-blue-400 rounded-full animate-ping-slow"></span>
                <span className="absolute -bottom-2 -left-2 w-2 h-2 bg-pink-400 rounded-full animate-ping-slow delay-300"></span>
              </span>
              {/* Decorative accent underline */}
              <span className="block mt-2 h-1 w-24 bg-gradient-to-r from-blue-400 via-pink-400 to-purple-400 rounded-full opacity-60 animate-fade-in-up"></span>
            </h1>
